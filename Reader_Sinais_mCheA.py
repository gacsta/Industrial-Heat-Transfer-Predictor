...
sinais = sorted(glob(r'C:\Users\Unesp\Documents\GitHub\Industrial-Heat-Transfer-Predictor\Quadrada-20210420T195112Z-001\Quadrada\Quadrada 0.01\C*\c*_quad_*.lvm'))
