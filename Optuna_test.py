...
###ADAM SOLVER --> Mini_Batch aproach --> 1024 samples (1 signal)
...
def objective(trial):
        ...
        MLP_epsilon = trial.suggest_float('MLP_epsilon', 1e-8, 10e-4, log=True)
        MLP_alpha = trial.suggest_float('MLP_alpha', 1e-8, 1e-4, log = True)
